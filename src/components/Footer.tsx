    ...
    {/* Ajoutez d'autres logos selon vos besoins */}
      ...
      <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <div className="navigation">
          ...
          <a href="/privacy-policy" className="block">Politique de confidentialité</a>
          <a href="/terms" className="block">Conditions d'utilisation</a>
          <a href="/sitemap" className="block">Carte du site</a>
          <a href="/faq" className="block">FAQ</a>
          <a href="/conditions-generales" className="block">Conditions génerales d'utilisation</a>
          <a href="/cookies" className="block">Politique des cookies</a>
        </div>
        ...
        <div className="social-media1">
          ...
          <a href="https://www.instagram.com/rcabasketwomen/" className="block">Instagram Féminin</a>
          <a href="https://www.instagram.com/rcabasketacademy/" className="block">Instagram Academie</a>
          <a href="https://www.facebook.com/RcaBasketyouth?mibextid=LQQJ4d" className="block">Facebook</a>
        </div>
      </div>
      ...
      <div className="social-media mx-auto text-center mt-4">
        ...
        <p style={{ fontSize: "0.5rem" }} className="mt-4">
          &copy; {new Date().getFullYear()} Raja Athletic Club. Tous droits réservés.
        </p>
      </div>
    </footer>
  );
